...
var FilterFocusTags = /*#__PURE__*/function () {
   ...
   */
  function FilterFocusTags() {
    _classCallCheck(this, FilterFocusTags);
  ...
  _createClass(FilterFocusTags, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('skill')) {
          obj['skill'] = _ApiClient["default"].convertToType(data['skill'], 'String');
        }
      }
