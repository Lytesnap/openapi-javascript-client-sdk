...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.CoachNotification();
  });
  ...
  describe('CoachNotification', function() {
    it('should create an instance of CoachNotification', function() {
      // uncomment below and update the code to test CoachNotification
      //var instance = new LytesnapBackendApi.CoachNotification();
      //expect(instance).to.be.a(LytesnapBackendApi.CoachNotification);
    });
