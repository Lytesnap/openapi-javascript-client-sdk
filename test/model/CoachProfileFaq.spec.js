...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.CoachProfileFaq();
  });
  ...
  describe('CoachProfileFaq', function() {
    it('should create an instance of CoachProfileFaq', function() {
      // uncomment below and update the code to test CoachProfileFaq
      //var instance = new LytesnapBackendApi.CoachProfileFaq();
      //expect(instance).to.be.a(LytesnapBackendApi.CoachProfileFaq);
    });
