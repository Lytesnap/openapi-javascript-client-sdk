...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineObject14();
  });
  ...
  describe('InlineObject14', function() {
    it('should create an instance of InlineObject14', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineObject14();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineObject14);
    });
    ...
    it('should have the property dataOfBirth (base name: "dataOfBirth")', function() {
      // uncomment below and update the code to test the property dataOfBirth
      //var instance = new LytesnapBackendApi.InlineObject14();
      //expect(instance).to.be();
    });
