...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.StudentProfilePost();
  });
  ...
  describe('StudentProfilePost', function() {
    it('should create an instance of StudentProfilePost', function() {
      // uncomment below and update the code to test StudentProfilePost
      //var instance = new LytesnapBackendApi.StudentProfilePost();
      //expect(instance).to.be.a(LytesnapBackendApi.StudentProfilePost);
    });
