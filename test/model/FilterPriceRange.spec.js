...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.FilterPriceRange();
  });
  ...
  describe('FilterPriceRange', function() {
    it('should create an instance of FilterPriceRange', function() {
      // uncomment below and update the code to test FilterPriceRange
      //var instance = new LytesnapBackendApi.FilterPriceRange();
      //expect(instance).to.be.a(LytesnapBackendApi.FilterPriceRange);
    });
