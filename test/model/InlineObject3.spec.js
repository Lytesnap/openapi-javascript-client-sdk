...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineObject3();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineObject3);
    });
