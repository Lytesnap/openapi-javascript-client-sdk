...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineObject9();
  });
  ...
  describe('InlineObject9', function() {
    it('should create an instance of InlineObject9', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineObject9();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineObject9);
    });
