...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineResponse20012();
  });
  ...
  describe('InlineResponse20012', function() {
    it('should create an instance of InlineResponse20012', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineResponse20012();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineResponse20012);
    });
    ...
    it('should have the property certificatePhoto (base name: "certificatePhoto")', function() {
      // uncomment below and update the code to test the property certificatePhoto
      //var instance = new LytesnapBackendApi.InlineResponse20012();
      //expect(instance).to.be();
    });
