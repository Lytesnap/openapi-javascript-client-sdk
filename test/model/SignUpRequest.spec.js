...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.SignUpRequest();
  });
  ...
  describe('SignUpRequest', function() {
    it('should create an instance of SignUpRequest', function() {
      ...
      //var instance = new LytesnapBackendApi.SignUpRequest();
      //expect(instance).to.be.a(LytesnapBackendApi.SignUpRequest);
    });
