...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineResponse20014();
  });
  ...
  describe('InlineResponse20014', function() {
    it('should create an instance of InlineResponse20014', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineResponse20014();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineResponse20014);
    });
    ...
    it('should have the property dateImplemented (base name: "dateImplemented")', function() {
      // uncomment below and update the code to test the property dateImplemented
      //var instance = new LytesnapBackendApi.InlineResponse20014();
      //expect(instance).to.be();
    });

    it('should have the property numberOfFeedback (base name: "numberOfFeedback")', function() {
      // uncomment below and update the code to test the property numberOfFeedback
      //var instance = new LytesnapBackendApi.InlineResponse20014();
      //expect(instance).to.be();
    });
