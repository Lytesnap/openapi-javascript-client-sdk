...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.CoachSessionProvided();
  });
  ...
  describe('CoachSessionProvided', function() {
    it('should create an instance of CoachSessionProvided', function() {
      // uncomment below and update the code to test CoachSessionProvided
      //var instance = new LytesnapBackendApi.CoachSessionProvided();
      //expect(instance).to.be.a(LytesnapBackendApi.CoachSessionProvided);
    });
