...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.StudentProfileBasicInfo();
  });
  ...
  describe('StudentProfileBasicInfo', function() {
    it('should create an instance of StudentProfileBasicInfo', function() {
      // uncomment below and update the code to test StudentProfileBasicInfo
      //var instance = new LytesnapBackendApi.StudentProfileBasicInfo();
      //expect(instance).to.be.a(LytesnapBackendApi.StudentProfileBasicInfo);
    });
