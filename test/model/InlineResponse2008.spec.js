...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineResponse2008();
  });
  ...
  describe('InlineResponse2008', function() {
    it('should create an instance of InlineResponse2008', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineResponse2008();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineResponse2008);
    });
    ...
    it('should have the property numCancellations (base name: "numCancellations")', function() {
      // uncomment below and update the code to test the property numCancellations
      //var instance = new LytesnapBackendApi.InlineResponse2008();
      //expect(instance).to.be();
    });
