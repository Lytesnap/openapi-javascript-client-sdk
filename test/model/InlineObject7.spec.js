...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LytesnapBackendApi.InlineObject7();
  });
  ...
  describe('InlineObject7', function() {
    it('should create an instance of InlineObject7', function() {
      ...
      //var instance = new LytesnapBackendApi.InlineObject7();
      //expect(instance).to.be.a(LytesnapBackendApi.InlineObject7);
    });
